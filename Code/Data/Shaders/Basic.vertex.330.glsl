...
in vec2 i_textureCoordinate;	//= texture Coordinates for texture 0
...
out vec2 textureCoordinates;	//= UV coordinates on the texture
...
void main()
{
	...
	screenPosition = u_projectionMatrix * u_modelMatrix * u_viewMatrix * i_vertexWorldPosition4;
	gl_Position = screenPosition;
	worldPosition = u_modelMatrix * i_vertexWorldPosition4;
	surfaceColor = i_vertexColor;
	textureCoordinates = i_textureCoordinate;
}
